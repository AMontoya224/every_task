...
function Register( props ){
    ...
    const onSubmitEmail = userNew => {
        ...
        axios.get( `https://every-task.onrender.com/api/users/register/email/${email}` )
            .then( res => {
    ...
    const onSubmitCreate = userNew => {
        ...
        axios.post( `https://every-task.onrender.com/api/users/register`, userCreate )
            .then( res => {
        ...
        <div className='register'>
            ...
            </h1>
            {
                ...
                ( bar === 1 ) ? <Form_1 onSubmitProp={onSubmitUser} initialFirstName={''} initialLastName={''} 
                                        initialUsertName={''} initialPhone={''} url={'https://every-task.onrender.com'}/> :
